		...
		<div class="footer-item">
			<div class="header-logo" itemscope itemtype="https://schema.org/Organization">
				<a href="<?php echo esc_url(home_url('/')); ?>" title="<?php esc_attr_e('Volver al Inicio', 'robertochoa'); ?>" itemprop="url">
					...
					<?php else : ?>
						<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-white.svg" width="70" height="57" alt="Robert Ochoa" class="img-logo response-class" itemprop="logo" loading="lazy" />
					<?php endif; ?>
				</a>
			</div>
