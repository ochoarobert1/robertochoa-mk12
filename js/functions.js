...
function robertochoaCustomLoad() {
    "use strict";
    console.log('%c J.A.R.V.I.S Protocol Activated', 'font-size: 12px; background: #BD121C; color: #FFF; padding: 3px 10px;');
    window.addEventListener('scroll', (e) => {
        ...
        if (window.pageYOffset > 105) {
            ...
            document.getElementById('mainRow').setAttribute('style', 'padding-top: ' + currHeaderHeight + 'px;');
        } else {
            document.getElementById('mainHeader').classList.remove('main-header-fixed');
            document.getElementById('mainRow').setAttribute('style', 'padding-top: 0px;');
        }
    });
}
